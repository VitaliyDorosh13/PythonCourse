...
print("Lets see what sort of hero we have here ")

if superHeroType == "Dark and Brooding":
    print("Ah, it says here you are 'Dark and Brooding'")
    print("I bet you had a tragic event in the past")
...
if superHeroType == "Too Polite":
    ...
    print("How are even going ti catch thet creiminal if you keep holding the door?")
    print("Don't say sorry to him - he's the villian")
if superHeroType == "Quick-Witted and Funny":
    ...
    print("What has 8 fingers, two tumbs, and isn't funny?")
    print("You")